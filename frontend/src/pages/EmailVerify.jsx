...
const onSubmitHandler=async(e)=>{
    try {
      ...
      const {data}=await axios.post(backendUrl+'/api/auth/verify-account',{otp})// we are sending otp
      if(data.success){
...
// if user tries to visit that email verify page he will be redirected to or navigated to home page 
useEffect(() => {
